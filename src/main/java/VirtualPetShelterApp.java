...
public class VirtualPetShelterApp {
	...
	public static void main(String[] args) {
		...
		VirtualPet pet3 = new VirtualPet("Sassy", "sassy Himalayan", 40, 60);
...
//			virtualPetShelter.displayStatus();
			...
			if (menuChoice.equals("1")) {
				...
				virtualPetShelter.allPetTick(null);
					System.out.println();
...
//				virtualPetShelter.allPetTick();
				...
				String petName = input.nextLine();
				virtualPetShelter.remove(petName);
//				virtualPetShelter.allPetTick();
				...
				virtualPetShelter.addPet(newPetName);
//				virtualPetShelter.allPetTick();
