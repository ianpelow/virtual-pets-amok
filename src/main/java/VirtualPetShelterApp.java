...
public class VirtualPetShelterApp {
	...
	public static void main(String[] args) {
		...
		VirtualPet pet1 = new VirtualPet("Shadow", "well-behaved and intelligent Golden Retriever", 60, 40);
		VirtualPet pet2 = new VirtualPet("Chance", "young and energetic American Bulldog", 50, 50);
		VirtualPet pet3 = new VirtualPet("Sassy", "Robotic - fiesty Himalayan", 40, 60);
		VirtualPet pet4 = new VirtualPet("Terminator", "Robotic - loyal to one person, guard dog - German Shepherd", 50, 50);
